    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acc', models.OneToOneField(default=None, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ...
                ('friend', models.ManyToManyField(blank=True, to='User.User')),
